<template>
<section>
<p class="text-2xl text-center mb-10 selection:bg-green-100 dark:selection:bg-green-700 text-slate-950 dark:text-slate-200">
  {{ props.text }}
</p>
...
const props = defineProps<{text: string, path: string, toAnimate: boolean}>();
let toUpdate = true;
